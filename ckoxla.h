/******************************************************************************
Header name: ckoxla.h     Rev: 01  Date: 18-Feb-90 Programmer: C.P.Armstrong

Header title:   System specific character set definitions.

Description:    This is pulled in by ckcxla.h.

Modification History:
    01  18-Feb-90   C.P.Armstrong   Dummy file created consisiting of the 
                                    CKUXLA definitions.
